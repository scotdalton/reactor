var FILES = [
  ...
  {id: "f4", name: "resume", type: "f", href: "resume.html"}
];

var COMMANDS = [
  {id: "c1", input: "whoami", output: function(){ return createStdOut("guest") }},
  {id: "c2", input: "whereami", output: function(){ return createStdOut("the website of Scot Dalton") }},
  {id: "c3", input:"pwd", output: function(){ return (React.createElement(StdOut, {output: React.createElement(Directory, {name: "/home/scot"})})); }},
  {id: "c4", input:"ls -a", output: function(){ return (React.createElement(Ls, {files: FILES})); }},
  {id: "c5", input:"cat README", output:function(){ return (""); }}
]
