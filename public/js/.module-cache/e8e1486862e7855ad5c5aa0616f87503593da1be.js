  ...
  render: function() {
    return (
      React.createElement("div", {className: "shell"}, 
        ...
        React.createElement(StdOut, {output: [React.createElement(Directory, {name: "."}), React.createElement(Directory, {name: ".."}), React.createElement(File, {name: "README", href: "README.html"})]}), 
