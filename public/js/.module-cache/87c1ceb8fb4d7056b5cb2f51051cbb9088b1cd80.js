...
var StdIn = React.createClass({displayName: "StdIn",
  getInitialState: function() {
    return {typedInput: this.props.input.charAt(0)};
  },
  type: function() {
    console.log(this.props.input.indexOf(this.state.typedInput))
    console.log(this.props.input.indexOf(this.state.typedInput) + 1)
    this.setState(
      {typedInput: this.props.input.slice(0, this.props.input.indexOf(this.state.typedInput) + 1)}
    );
  },
