...
var COMMANDS = [
  {id: 1, input: "whoami", output: function(){ return (React.createElement(StdOut, {output: "guest"})); }},
  {id: 2, input: "whereami", output: function(){ return (React.createElement(StdOut, {output: "the website of Scot Dalton"})); }},
