...
var COMMANDS = [
  {id: 1, input: "whoami", output: React.createElement(StdOut, {output: "guest"})},
  {id: 2, input: "whereami", output: React.createElement(StdOut, {output: "the website of Scot Dalton"})},
  {id: 3, input:"pwd", output: React.createElement(StdOut, {output: React.createElement(Directory, {name: "/home/scot"})})},
  {id: 4, input:"ls -a", output: React.createElement(Ls, {files: FILES})},
  {id: 5, input:"cat README", output:""}
]
  ...
  createCommand: function(data) {
    return(
      React.createElement(Command, {
        key: data.id, 
        input: data.input, 
        output: function() { return(data.output) }()}
      )
    );
  },
  ...
  render: function() {
    return (
      React.createElement("div", {className: "shell"}, 
        this.props.commands.map(this.createCommand)
      )
    );
  }
});
